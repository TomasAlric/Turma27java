programa
{
	...
	diário de seu trabalho. Toda vez que ele traz um peso de tomate maior que 
	...
	funcao inicio()
	{
		...
		E = (P - 50)
		valor = E * M
		escreva("O valor da multa é: " +valor+ " reais")
		}
		senao{
		escreva("Não há excedentes para serem pagos")	
		}
	}
}
/* $$$ Portugol Studio $$$ 
