...
de poluição aceitável varia de 0,05 até 0,25. Se o índice sobe para 0,3 as indústrias 
 ...
 */
	funcao inicio()
	{
		...
		escreva("Digite qual o índice: ")
		leia(indice)

		se (indice>0.05 e indice<=0.29){
			escreva("O índice está aceitável para as industrias")	
		}	
		senao se(indice>=0.3 e indice<=0.39){
			escreva("\nAs industrias 1º grupo são intimadas a suspenderem suas atividades")	
		}
		senao se(indice>=0.4 e indice<=0.49){
			escreva("\nAs industrias do 1º e 2º grupo são intimadas a suspenderem suas atividades")
		}
		senao			
		escreva("\nTodas as industrias devem ser notificados a paralisarem suas atividades")
	}
